  ...
  return (
    <div>
      ...
      <div className="navbar">
        ...
        <button
          className={activePage === "challenge5" ? "active" : ""}
          onClick={() => setActivePage("challenge5")}
        >
          Challenge 5
        </button>

        <button
          className={activePage === "challenge6" ? "active" : ""}
          onClick={() => setActivePage("challenge6")}
        >
          Challenge 6
        </button>

        <button
          className={activePage === "challenge7" ? "active" : ""}
          onClick={() => setActivePage("challenge7")}
        >
          Challenge 7
        </button>

        <button
          className={activePage === "challenge8" ? "active" : ""}
          onClick={() => setActivePage("challenge8")}
        >
          Challenge 8
        </button>
      </div>
      ...
      {activePage === "challenge5" && (
        <div className="section" id="section">
          <h2>Challenge 5 - React Context API</h2>
          <p>
            Use the toggle button above to switch between Light and Dark mode.
            Theme preference is stored in localStorage.
          </p>
        </div>
      )}
      {activePage === "challenge6" && (
        <div className="section" id="section">
          <h2>Challenge 6 - Progressive Web App</h2>
          <p>This app is configured as a PWA.</p>
          <p>Service worker is registered.</p>
          <p>You can install this app from the browser.</p>
        </div>
      )}
      
      {activePage === "challenge7" && (
        <div className="section" id="section">
          <Challenge7 />
        </div>
      )}

      {activePage === "challenge8" && (
        <div className="section" id="section">
          <Challenge8 />
        </div>
      )}
